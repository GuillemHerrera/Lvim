      ...
      init_options = {
        settings = {
          args = {
            '--line-length=170',
            '--select=ALL',
            '--ignore=N818,ANN204,ANN201,ANN101,E501,T201,D101,D107,D105,D205,D400,D212,D415,Q000,S101,PD011,PD002,I001,PLR2004,SIM114,D401,SIM108,SIM118,S608,UP032,ANN001',
            -- '--ignore=ANN204',
            -- '--ignore=T201',
            -- '--ignore=E50l',
            '--fixable=D,W'
